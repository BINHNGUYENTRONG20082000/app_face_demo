...
from identity_vm_app.camera_recognition.infer import resize_for_analyze, scale_bbox_xyxy
from identity_vm_app.camera_recognition.weapon import (
...
from identity_vm_app.engine.yolo_person_tracker import assign_faces_to_person_tracks_multi
...
def plan_person_face_assignments(
    ...
    *,
    ...
    if frame_bgr is not None and bool(s.IVM_FACE_POSE_REFINE):
        from identity_vm_app.engine.pose_face_refine import refine_grouped_with_pose
