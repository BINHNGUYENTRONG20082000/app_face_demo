...
from identity_vm_app.engine.yolo_person_tracker import tracker_unavailable_reason, vm_tracking_available
...
from identity_vm_app.services import video_offline_analyze as va
from identity_vm_app.services.video_analyze_fps import (
    default_display_name,
    parse_sample_fps,
    sample_fps_label,
)
from identity_vm_app.services.video_face_search import search_reports_by_embedding
...
def get_report_track_scene_image(report_id: str):
    ...
    if frame is None:
        raise HTTPException(status_code=404, detail="Không có khung gốc")
    from identity_vm_app.services.video_report_crops import parse_weapon_boxes
    from identity_vm_app.services.weapon_crops import render_track_scene_crop_bgr
