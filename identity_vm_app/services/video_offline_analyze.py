...
def _analyze_segment(
    *,
    ...
    from identity_vm_app.engine.yolo_person_tracker import (
    ...
    *,
    ...
    try:
        ...
        try:
            ...
            from identity_vm_app.bulk_folder_register import _dispose_worker_engine, _release_bulk_infer_resources
        ...
        try:
            from identity_vm_app.engine.gpu_cleanup import maybe_gpu_soft_cleanup
