...
from identity_vm_app.camera_recognition.activity_log import record as log_activity
from identity_vm_app.camera_recognition.analyze_recording import record_visual_frame
from identity_vm_app.camera_recognition.camera_model_stack import CameraModelStack
from identity_vm_app.camera_recognition.display import build_analyze_visual_bgr
from identity_vm_app.camera_recognition.infer import (
    identify_and_scale,
        ...
        *,
        ...
        if use_live_reports:
            ...
            if run_weapon and live_sess is not None:
                from identity_vm_app.camera_recognition.weapon_alerts import emit_weapon_track_alerts
